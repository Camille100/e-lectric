				...
				<div className="menu">
					...
					<button className="navbar-burger icons" onClick={handleClick}>
						<svg viewBox="0 -53 384 384" xmlns="http://www.w3.org/2000/svg">
							<path fill="white" d="M368 155H16a16 16 0 010-32h352a16 16 0 010 32zm0 0M368 32H16a16 16 0 010-32h352a16 16 0 010 32zm0 0M368 277H16a16 16 0 010-32h352a16 16 0 010 32zm0 0"/>
						</svg>
					</button>
				</div>
			</div>
