    ...
    return (
        <div className="pageHome">
            ...
            <section className="whyChoose">
                ...
                <ul>
                    <li>Electricien expérimenté à votre écoute</li>
                    <li>Conseils lors de la planification du projet, et pour l'entretien de votre système électrique</li>
                    <li>Suivi après installation</li>
                    <li>Utilisation de matériaux de qualité, en provenance de fournisseurs reconnus</li>
                </ul>
            ...
            <section className="services-offered">
                ...
                <div className="services-items">
                    ...
                    <HashLink smooth to="/services#installation" className="installation item">
                        ...
                        <p>Installation électrique</p>
                    </HashLink>

                    <HashLink smooth to="/services#renovation" className="renovation item">
                        ...
                        <p>Rénovation électrique <br /> & mise en conformité</p>
                    </HashLink>

                    <HashLink smooth to="/services#depannage" className="fixing item">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 211.7 211.7" fill="#e9e9e9">
                        ...
                        <p>Dépannage électrique</p>
                    </HashLink>

                    <HashLink smooth to="/services#domotique" className="automation item">
                        <svg viewBox="0 0 54 56" xmlns="http://www.w3.org/2000/svg" fill="#e9e9e9">
