            ...
            <section className="services">
                ...
                <div className="services-items">
                    ...
                    <div className="installation item">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 463.3 463.3" fill="#10272f">
                    ...
                    <div className="fixing item">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 211.7 211.7" fill="#10272f">
                    ...
                    <div className="automation item">
                        <svg viewBox="0 0 54 56" xmlns="http://www.w3.org/2000/svg" fill="#10272f">
